...
if __name__ == '__main__':
    ...
    train_dataset = AnimalDataset(root=r"D:\AI\Dataset\animals", is_train=True, transform=transform)
    ...
    # train_dataset = ImageFolder(root =r"D:\AI\Dataset\animals", transform= transform)
